    ...
    >
        {slides.map((slide, index) =>(
            <SwiperSlide key={index}>
                <div className="bg-[#D8E7C7] h-[800px] bg-cover bg-center flex flex-col md:flex-row
                items-center justify-center gap-4" style={{backgroundImage: `url(${assets.leef_layer_bg})`}}>
